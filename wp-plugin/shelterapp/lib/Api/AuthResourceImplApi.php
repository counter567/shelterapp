...
/**
 * AuthResourceImplApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class AuthResourceImplApi
{
     ...
     */
    public function authLoginGet(string $contentType = self::contentTypes['authLoginGet'][0])
    {
     ...
     */
    public function authLoginGetWithHttpInfo(string $contentType = self::contentTypes['authLoginGet'][0])
    {
     ...
     */
    public function authLoginGetAsync(string $contentType = self::contentTypes['authLoginGet'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authLoginGetAsyncWithHttpInfo(string $contentType = self::contentTypes['authLoginGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\TokenResponse';
        $request = $this->authLoginGetRequest($contentType);
     ...
     */
    public function authLoginGetRequest(string $contentType = self::contentTypes['authLoginGet'][0])
    {
    ...
    {
        list($response) = $this->authLogoutGetWithHttpInfo($contentType);
        return $response;
    }
