...
class UserResourceApi
{
    ...
    public const contentTypes = [
        'usersCreateTenantAndSuperUserPost' => [
            'application/json',
        ],
        'usersDelete' => [
            'application/json',
    ...
    /**
     * Operation usersCreateTenantAndSuperUserPost
     *
     * @param  \OpenAPI\Client\Model\CreateTenantAndUserRequest $create_tenant_and_user_request create_tenant_and_user_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['usersCreateTenantAndSuperUserPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CreateTenantAndUserResponse
     */
    public function usersCreateTenantAndSuperUserPost($create_tenant_and_user_request = null, string $contentType = self::contentTypes['usersCreateTenantAndSuperUserPost'][0])
    {
        list($response) = $this->usersCreateTenantAndSuperUserPostWithHttpInfo($create_tenant_and_user_request, $contentType);
        return $response;
    }

    /**
     * Operation usersCreateTenantAndSuperUserPostWithHttpInfo
     *
     * @param  \OpenAPI\Client\Model\CreateTenantAndUserRequest $create_tenant_and_user_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['usersCreateTenantAndSuperUserPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CreateTenantAndUserResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function usersCreateTenantAndSuperUserPostWithHttpInfo($create_tenant_and_user_request = null, string $contentType = self::contentTypes['usersCreateTenantAndSuperUserPost'][0])
    {
        $request = $this->usersCreateTenantAndSuperUserPostRequest($create_tenant_and_user_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CreateTenantAndUserResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CreateTenantAndUserResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CreateTenantAndUserResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\CreateTenantAndUserResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CreateTenantAndUserResponse',
    ...
    /**
     * Operation usersCreateTenantAndSuperUserPostAsync
     *
     * @param  \OpenAPI\Client\Model\CreateTenantAndUserRequest $create_tenant_and_user_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['usersCreateTenantAndSuperUserPost'] to see the possible values for this operation
     *
     ...
     */
    public function usersCreateTenantAndSuperUserPostAsync($create_tenant_and_user_request = null, string $contentType = self::contentTypes['usersCreateTenantAndSuperUserPost'][0])
    {
        return $this->usersCreateTenantAndSuperUserPostAsyncWithHttpInfo($create_tenant_and_user_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation usersCreateTenantAndSuperUserPostAsyncWithHttpInfo
     *
     * @param  \OpenAPI\Client\Model\CreateTenantAndUserRequest $create_tenant_and_user_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['usersCreateTenantAndSuperUserPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersCreateTenantAndSuperUserPostAsyncWithHttpInfo($create_tenant_and_user_request = null, string $contentType = self::contentTypes['usersCreateTenantAndSuperUserPost'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CreateTenantAndUserResponse';
        $request = $this->usersCreateTenantAndSuperUserPostRequest($create_tenant_and_user_request, $contentType);
    ...
    /**
     * Create request for operation 'usersCreateTenantAndSuperUserPost'
     *
     * @param  \OpenAPI\Client\Model\CreateTenantAndUserRequest $create_tenant_and_user_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['usersCreateTenantAndSuperUserPost'] to see the possible values for this operation
     *
     ...
     */
    public function usersCreateTenantAndSuperUserPostRequest($create_tenant_and_user_request = null, string $contentType = self::contentTypes['usersCreateTenantAndSuperUserPost'][0])
    {



        $resourcePath = '/users/createTenantAndSuperUser';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($create_tenant_and_user_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_tenant_and_user_request));
            } else {
                $httpBody = $create_tenant_and_user_request;
            }
