            ...
            if (isset($all_plugins[$plugin_key])) {
                ...
                <p><?php _e('In order to work properly you need to activate the "' . $plugin_label . '" plugin.', 'shelterapp'); ?>
                    <a class="install-now button" data-slug="<?php echo $plugin_slug; ?>"
                        href="/wp-admin/plugins.php?_wpnonce=<?php echo $nonce; ?>&action=activate&plugin=<?php echo $plugin_key; ?>"
                        aria-label="<?php echo $plugin_label; ?> jetzt aktivieren" data-name="<?php echo $plugin_label; ?>">Jetzt
                        aktivieren</a>
                ...
                <p><?php _e('In order to work properly you need to install the "' . $plugin_label . '" plugin.', 'shelterapp'); ?>
                    <a class="install-now button" data-slug="<?php echo $plugin_slug; ?>"
                        href="/wp-admin/update.php?action=install-plugin&amp;plugin=<?php echo $plugin_slug; ?>&amp;_wpnonce=<?php echo $nonce; ?>"
                        aria-label="<?php echo $plugin_label; ?> jetzt installieren" data-name="<?php echo $plugin_label; ?>">Jetzt
                        installieren</a>
                </p>
                <?php
            }
