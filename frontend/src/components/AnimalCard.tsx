        ...
        >
            ...
            >
                ...
                <div className="flex items-center flex-col flex-auto overflow-hidden">
                    <div className="animal-card-image-container flex items-center justify-center h-44 pt-4">
                        <div
                            className="animal-card-image-border aspect-square bg-gray-100 w-40 rounded-full flex flex-col items-center absolute"></div>
                        {mainPictureFileUrl && (
                            <img
            ...
            {sex && <Gender sex={sex}/>}
              ...
              Alter Unbekannt
                    ...
                    <div
                        className="animal-card-info justify-center card-bottom flex items-center w-full relative flex-col rounded-b mt-4 min-h-[42px]">
